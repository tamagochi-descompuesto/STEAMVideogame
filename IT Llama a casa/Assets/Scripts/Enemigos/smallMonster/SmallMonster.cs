...
using UnityEngine;
/*
Permite que el SmallMonster detecte si el jugador está en el rango de visión y 
...
public class SmallMonster : MonoBehaviour
{
    ...
    public SpriteRenderer sprSmallMonster;
    ...
    void Start()
    {
        //obtenemos la posición inicial del enemigo en el mapa
        ...
        sprSmallMonster = GetComponent<SpriteRenderer>();
    }
    ...
    void Update()
    {
        if(rigidbody.velocity.x>=0){
            sprSmallMonster.flipX = true;
        }else{
            sprSmallMonster.flipX = false;
        }
        ...
        if(distancia<radioVision){
            ...
            if(SmallMonsterChoque.SmallMonsterChoco){
